...
# # songplay_id is not needed as it is auto-incremented

# --- other type of upsert
# DO UPDATE SET start_time = songplays.start_time, \
...
# --- other type of upsert
# DO UPDATE SET title  = songs.title, \
